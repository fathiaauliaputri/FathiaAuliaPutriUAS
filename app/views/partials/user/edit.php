                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="salt">Salt <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-salt"  value="<?php  echo $data['salt']; ?>" type="text" placeholder="Enter Salt"  required="" name="salt"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

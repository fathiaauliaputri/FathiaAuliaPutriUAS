                            ...
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="penyakit">Penyakit <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-penyakit"  value="<?php  echo $this->set_field_value('penyakit',""); ?>" type="text" placeholder="Enter Penyakit"  required="" name="penyakit"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

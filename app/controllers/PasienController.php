...
class PasienController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				pasien.id LIKE ? OR 
				pasien.nama LIKE ? OR 
				pasien.penyakit LIKE ? OR 
				pasien.telepon LIKE ? OR 
				pasien.alamat LIKE ? OR 
				pasien.tanggal_lahir LIKE ? OR 
				pasien.tanggal_masuk LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama","penyakit","telepon","alamat","tanggal_lahir","tanggal_masuk");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","nama","penyakit","telepon","alamat","tanggal_lahir","tanggal_masuk");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'nama' => 'required',
